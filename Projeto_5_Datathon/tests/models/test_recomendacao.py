...
def test_obter_recomendacao_usuario_cold_start(mock_session, mocker: MockerFixture):
    mock_session.query.return_value.filter_by.return_value.all.return_value = []
    mocker.patch("models.recomendacao.obter_recomendacoes_cold_start", return_value=["cold_start_recommendation"])

    result = recomendacao.obter_recomendacao_usuario("usuario_id", mock_session)
...
def test_obter_recomendacao_usuario_personalizada(mock_session, mocker: MockerFixture):
    mock_atividades = [
...
def test_obter_recomendacoes_cold_start(mocker: MockerFixture):
    ...
    result = recomendacao.obter_recomendacoes_cold_start()
...
def test_obter_recomendacoes_personalizadas(mock_session, mocker: MockerFixture):
    ...
    result = recomendacao.obter_recomendacoes_personalizadas("usuario_id", mock_session)
